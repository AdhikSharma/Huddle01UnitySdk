...
#region Unity Callbacks
    ...
    private void HuddleInitForWebgl(string projectId)
    {
#if UNITY_WEBGL
        Huddle01JSNative.InitHuddle01WebSdk(projectId);
...
#region Subscribe events
    ...
    public async void ChangeAudioDevice(string deviceName)
    {
#if !UNITY_WEBGL
    ...
    public async void ConsumeRemotePeer(string peerId, string label)
    {
...
#if !UNITY_WEBGL
        _ = _localPeer.Consume(consumeData);
#endif
    }
